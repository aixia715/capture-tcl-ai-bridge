...
check {software version} $::CaptureAiBridgeVersion {0.1.0-beta.2-dev}
...
if {[llength [info commands ::_captureAiLoadDescriptor]] > 0} {
    ...
    puts -nonewline $descriptorChannel [format \
        {{"service":"capture-tcl-bridge","version":"0.1.0-beta.2-dev","protocolVersion":1,"baseUrl":"http://127.0.0.1:8767","token":"descriptor-token","capturePid":%d,"serverPid":1234}} \
        [pid]]
